...
export default function ServiceSlider({ slides }) {
  ...
  return (
    <div className="relative h-[300px] w-full overflow-hidden bg-gradient-to-r from-gray-900 to-gray-800">
        ...
        {slides.map((slide, index) => (
          <div key={index} className="each-slide-effect">
            ...
            <div className="relative h-[300px] w-full">
              ...
              {/* copy */}
              <div className="absolute lg:left-112 inset-0 flex items-center px-6 lg:px-24 z-20">
                <div className="max-w-xl space-y-4  animate-slide-fade-in text-center">
      ...
      {/* global styles trimmed for brevity; keep your animations if you like */}
    </div>
  );
}
