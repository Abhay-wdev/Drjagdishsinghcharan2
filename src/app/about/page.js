...
export default function Home() {
  const slides = [
    ...
    },
    {
      ...
      title: "Dr. Jagdish Singh Charan",
      subtitle: "Joint Replacement Surgery – Move Freely Again with Expert Surgery for Pain-Free Living",
    },
    {
      image: "/images/services/kneeinjury.webp",
      title: "Dr. Jagdish Singh Charan",
      subtitle: "Sports Injury Care – Specialized Recovery for Athletes and Active Lifestyles",
    },
  ];
  ...
  return (
    <div className="text-blue-800">
      ...
      <section className="bg-blue-50 py-12 px-2 text-center">
        ...
        >
          At Dr. Jagdish Singh Charan’s Orthopedic & Spine Center, our mission is simple: restore your mobility, relieve pain, and help you reclaim the life you love — with empathy, innovation, and unmatched surgical expertise.
        </motion.p>
      ...
      <section className="bg-blue-100 py-16 px-6 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg">
          Founded by <strong>Dr. Jagdish Singh Charan</strong>, our center is rooted in a deep commitment to healing with empathy and skill. Trained at premier institutions like Apollo and SKIMS, Dr. Charan’s vision is to make cutting-edge spine and joint care accessible and personalized — where every treatment is backed by data, heart, and a steady surgeon's hand.
        </p>
      </section>
              ...
              >
                <div className="bg-white shadow-md rounded-xl px-6 py-8 text-center hover:shadow-lg transition-shadow">
                  <div className="text-4xl flex justify-center mb-2">
                    <Image height={60} width={60} src={item.icon} alt={item.label} />
                  </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-white hover:scale-105   shadow-md rounded-xl p-5 text-left hover:shadow-lg transition-all hover:-translate-y-1"
              >
               <div className="relative w-full  h-50 mb-3"> {/* adjust h-32 as needed */}
  <Image
    src={icon}
    alt={title}
    fill
  ...
  />
                ...
                <h3 className="font-semibold flex justify-center text-xl mb-2 text-blue-800">{title}</h3>
